...
DEFAULT_SECTORS = [
    "CHEMICALS", "CONSTRUCTION MATERIALS", "METALS & MINING", "FOREST MATERIALS",
    "AUTOMOBILES & AUTO COMPS", "CONSUMER DURABLE", "TEXTILES",
    "MEDIA, ENTERTAINMENT & PUBLICATION", "REALTY", "CONSUMER SERVICES",
    "OIL, GAS & CONSUMABLE FUELS", "FAST MOVING CONSUMER GOODS (FMCG)",
    "FINANCIAL SERVICES", "HEALTHCARE", "CONSTRUCTION", "CAPITAL GOODS",
    "INFORMATION TECHNOLOGY", "SERVICES", "TELECOMMUNICATION", "POWER",
...
def load_master_database(file) -> pd.DataFrame:
    ...
    sym_col = _find_col(df.columns, ["Symbol", "Ticker", "NSE Symbol", "NSE Code"])
...
def main():
    ...
    with st.sidebar:
        ...
        st.caption("Assign each of the 22 sectors to its current RRG quadrant.")
    ...
    try:
        master = load_master_database(master_file)
